        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                if(usuario.getROL()==2) {
                    ...
                    //se evalua si se está dentro del periodo de evaluación
                    if(validarFecha(turno.getDateInicial().split(" ")[0],
                            turno.getDateInicial().split(" ")[1],
                            formatoDeFecha.format(fecha_actual),
                            formatoDeHora.format(fecha_actual)
                    ) &&
                            validarFecha(formatoDeFecha.format(fecha_actual),
                                    formatoDeHora.format(fecha_actual),
                                    turno.getDateFinal().split(" ")[0],
                                    turno.getDateFinal().split(" ")[1]
                            )
                    ){
                        ...
                        Toast.makeText(TurnoActivity.this,
                                "Evaluación no disponible. consulte el periodo",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
